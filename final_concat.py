...
matei_paths = ['walk_matei1/conv_and_frequency_walk_matei1_data.csv', 'walk_matei2/conv_and_frequency_walk_matei2_data.csv', 'walk_matei3/conv_and_frequency_walk_matei3_data.csv']
stan_paths = ['walk_stan1/conv_and_frequency_walk_stan1_data.csv', 'walk_stan2/conv_and_frequency_walk_stan2_data.csv', 'walk_stan3/conv_and_frequency_walk_stan3_data.csv']
beni_paths = ['walk_beni1/conv_and_frequency_walk_beni1_data.csv', 'walk_beni2/conv_and_frequency_walk_beni2_data.csv', 'walk_beni3/conv_and_frequency_walk_beni3_data.csv']
